...
def garantir_ambiente():
    print("\n" + "="*50)
    print("⚙️ [BOOTSTRAP] INICIANDO VERIFICAÇÃO DE SISTEMA")
    print("="*50)
    ...
    for package in deps:
        ...
        try:
            ...
            print(f"📦 Pacote ausente: {package}. Instalando...")
            try:
...
class KnowledgeBase:
    ...
    def _load_embedder(self):
        if not self.embedder:
            ...
            # Modelo super leve e rápido para pesquisar os PDFs
    ...
    def sync(self):
        ...
        for pdf_file in pdf_files:
            ...
            try:
                with open(path, 'rb') as f:
                    ...
                    # Fatiamento Tático: Corta o PDF em blocos de 1000 letras para a IA ler melhor
                    chunk_size = 1000
                    overlap = 200 # Sobreposição para não cortar frases a meio
        ...
        if not self.chunks:
            return "⚠️ Os PDFs foram lidos, mas nenhum texto pôde ser extraído (podem ser apenas imagens digitalizadas)."
...
os.makedirs("static/docs", exist_ok=True) # Pasta vitalícia dos PDFs
...
<body>
    ...
    <div id="chat-wrapper">
        <div id="chat">
            <div class="msg sys-msg">
                SISTEMA RAG (PDF) ATIVADO.<br><br>
                1. Coloque os seus PDFs na pasta <b>static/docs</b>.<br>
                2. Digite <b>/doc sync</b> para a IA ler todos de uma vez.<br>
                3. Ative o <b>MODO DOC</b> para conversar apenas sobre os arquivos.
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // VARIÁVEL DE ESTADO DO NOVO BOTÃO
        let ragMode = false;
        ...
        function sendMsg() {
            ...
            // Exibe a mensagem limpa para o usuário (sem o /doc)
            ...
            // INJEÇÃO SILENCIOSA DO /DOC NO BACKEND
        ...
        while True:
            ...
            if cmd_lower.startswith("/doc"):
                ...
                if acao.lower() == "sync":
                    ...
                    # Roteia a pesquisa para o Cérebro de Texto ler os pedaços exatos que achamos
                    ...
                    STOP_GEN = False
                    try:
                        # Temperature mais baixa (0.3) para ele ser factual e não inventar
...
if __name__ == "__main__":
    print("\n" + "="*50)
    print("🚀 INICIANDO R2 WEB OS (MODO SUPREMO)")
